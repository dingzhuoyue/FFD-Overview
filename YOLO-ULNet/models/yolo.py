...
from models.common import ASFFV5, DWConv, SPP, SPPF, Focus, MobileOneBlock, DP_C3, C3Ghost, GhostConv, VoVGSCSP, GSConv, \
    BottleneckCSP, C3, C3TR, Bottleneck, C3SPP, conv_bn_relu_maxpool, Shuffle_Block, Conv_BN_HSwish, \
    MobileNetV3_InvertedResidual, CBAM, MobileOne, C2f, C3_Faster, GhostBottleneck, Concat, resnet501, resnet502, \
    resnet503, CARAFE, Expand, Contract, InvertedResidual, PyramidPoolAgg, LocalGlobalFuse, TopFormer_Block
...
class Model(nn.Module):
    ...
    def _forward_once(self, x, profile=False, visualize=False):
        ...
        for m in self.model:
            ...
            feature_vis = True
            if m.type =='models.common.C3_Faster' and feature_vis and m.i == 20:
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                 BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, conv_bn_relu_maxpool, Shuffle_Block, Conv_BN_HSwish, MobileNetV3_InvertedResidual, CBAM,
                 GSConv, VoVGSCSP, GhostConv, C3Ghost, DP_C3, MobileOneBlock, MobileOne, C2f, C3_Faster, InvertedResidual]:
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)

            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, C3, C3TR, C3Ghost, VoVGSCSP, C2f, C3_Faster]:
...
def _forward_once(self, x, profile=False, visualize=False):
    ...
    for m in self.model:
        ...
        if m.type == 'models.common.C3_Faster' and m.i == 20:
            feature_visualization_all(x, m.type, m.i)
    return x
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s-shuffle-gsconv-c3_faster.yaml', help='model.yaml')
