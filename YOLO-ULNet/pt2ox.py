...
class Yolov5ONNX(object):
    ...
    def inference(self, img_path):
        ...
        or_img = cv2.resize(img, (320, 320))  # resize后的原图 (640, 640, 3)
...
if __name__ == "__main__":
    ...
    onnx_path = 'D:\\yolov5-All\\yolov5-6.1Network Structure Modification\\weights\\yolov5s-shuffle-gsconv-faster320.onnx'
    model = Yolov5ONNX(onnx_path)
    # output, or_img = model.inference('data/images/img.png?imageView2/1/q/50')
    output, or_img = model.inference('C:\\Users\\dingzhuoyue\\Desktop\\img\\11378.jpg')
    # print('pred: 位置[0, 10000, :]的数组')
    # print(output.shape)
    # print(output[0, 10000, :])
    outbox = filter_box(output, 0.01, 0.01)  # 最终剩下的Anchors：0 1 2 3 4 5 分别是 x1 y1 x2 y2 score class
    ...
    cv2.imwrite('C:\\Users\\dingzhuoyue\\Desktop\\img\\test113782.jpg', or_img)

    # 计算帧率
    fps_counter.stop()
    fps = 1.0 / fps_counter.getTimeSec()
    ...
    # 显示时间间隔信息
    print(f"Time Interval: {time_interval:.4f} seconds")