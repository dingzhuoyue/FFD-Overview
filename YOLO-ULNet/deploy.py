...
if __name__ == "__main__":
    ...
    parser.add_argument('--imgpath', type=str, default='C:\\Users\\dingzhuoyue\\Desktop\\img\\11378.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='./weights/yolov5s-shuffle-gsconv-faster320.onnx')
    parser.add_argument('--confThreshold', default=0.01, type=float, help='class confidence')
    parser.add_argument('--nmsThreshold', default=0.01, type=float, help='nms iou thresh')
    parser.add_argument('--objThreshold', default=0.01, type=float, help='object confidence')
