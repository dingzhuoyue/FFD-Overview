...
# def feature_visualization_all(x, module_type, stage, save_dir=Path('D:\\yolov5-All\\yolov5-6.1Network Structure Modification\\runs')):
#     if 'Detect' not in module_type:
...
def feature_visualization_all(features, model_type, model_id, feature_num=64, row=8, col=8):
    """
