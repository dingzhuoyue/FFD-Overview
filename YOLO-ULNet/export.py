...
@torch.no_grad()
def run(data=ROOT / 'data/fire-smoke.yaml',  # 'dataset.yaml path'
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'C:\\Users\\dingzhuoyue\\Desktop\\weights\\yolov7-tiny.pt', help='model.pt path(s)')
