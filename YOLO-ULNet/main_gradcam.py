...
parser.add_argument('--model-path', type=str, default="weights\\yolov5s-shuffle-gsconv-faster.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='datasets1\\images\\val\\788.jpg', help='input image path')
parser.add_argument('--output-dir', type=str, default='runs/result', help='output dir')
